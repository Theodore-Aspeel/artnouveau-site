...
**P0 — Immédiat (prochains jours) :** l'audit a refusé le raccord de la paire locale V2 / ancien détail. Ne pas relancer les mêmes superpositions ni insérer le détail par fondu. Sélectionner explicitement un master natif livré, vérifier le cadrage et les pixels disponibles, puis, après approbation du périmètre minimal, produire **un unique** spike Remotion standard de cinq secondes à résolution de diagnostic compatible (pas un Reel Full HD publiable). Évaluer ensuite si un détail enrichi fidèle mérite une préparation ciblée. La préparation du prototype ne vaut pas autorisation de publication.
