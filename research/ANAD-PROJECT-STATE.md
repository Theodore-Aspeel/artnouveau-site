...
## 0F. D1 — Gel des anciennes directions, contrat IGNANT déjà mesuré (23-09-2026)

**VALIDÉ par Théodore — étape 1 de reprise :** suspendre les corrections et reconstructions successives dans le prototype Sites autonome et sur les anciennes directions D1. Garder les PR et les versions comme archives, sans les fusionner, publier, clôturer ni supprimer automatiquement. Préserver en priorité le souhait final : une expérience ANAD utilisant ses propres photographies et ses quatre lots photographiques sur les principes visuels montrés dans les vidéos IGNANT. **Les textes, gabarits et directions antérieurs ne sont pas automatiquement validés** ; leurs bases techniques restent de possibles ressources à examiner plus tard. Aucun nouvel outil payant, nouveau site, dépôt, travail de développement ou extraction photographique autorisé par ce gel.

**VALIDÉ — lots photographiques conservés :** Habitations Marconi n° 32, Maison Piot, Palais Chinois / Palazzina Cinese et Maison Coilliot. Les autres sujets des anciens pilotes D1 restent archivés hors de ce groupe. Les quatre lots, la provenance et les droits des photographies doivent être préservés dans leurs emplacements privés existants, sans les copier dans GitHub public.

**VÉRIFIÉ par lecture du document fourni :** le contrat `ANAD-2.0-D1-Contrat-de-conception-IGNANT-2026-09-23 (1).md` **a déjà mesuré** l'accueil IGNANT et l'article Aeyde Haus, au viewport **1363 × 936 CSS px** : entre autres photo d'accueil 532 × 532 px, titre 40 px, ouverture de l'article en deux moitiés 674 px et titre 48 px. Les mesures mobile/tablette ne sont pas présentes ; les règles ANAD proposées dans ce contrat ne sont pas des mesures de la référence ou des compositions ANAD validées. La section mentionnant Coilliot/Hiboux/Villino/Bastin est une liste historique d'anciens pilotes et ne modifie pas le groupe corrigé des quatre lots. L'article IGNANT mesuré dans le contrat ne doit pas être confondu automatiquement avec celui montré dans les vidéos utilisateur.

**DIAGNOSTIC DE PROCESSUS / PROPOSÉ :** refaire simplement l'étape « mesurer IGNANT » ne répondrait pas à l'échec après le contrat existant. Avant toute nouvelle implémentation, examiner la traçabilité entre le passage exact de la référence choisi, les mesures disponibles, les vraies proportions des photographies ANAD, une spécification visuelle contrôlable et la comparaison des rendus dans un navigateur accessible. Les mesures sont nécessaires dans les cas pertinents mais **pas suffisantes** sans composition éditoriale adaptée et revue visuelle humaine. Étape 2 à recadrer : rechercher seulement les preuves manquantes et tester une composition bornée, sans relancer un audit général ni développer les quatre pages.

**STATUT :** gel de pilotage RÉALISÉ dans cette branche documentaire ; aucun verrouillage technique de Sites ni fermeture des PR ; aucun changement de `main`. L'étape suivante requiert un cadrage explicite, puis une validation humaine d'une preuve visuelle, avant consolidation. Voir le checkpoint spécialisé sur cette même branche.

## 0E. D1 — STOP consolidation et reprise de cadrage artistique (23-09-2026)

**VALIDÉ par retour humain de Théodore :** la dernière prévisualisation privée D1, livrée avec les quatre bons articles et photographies, **n'est PAS approuvée artistiquement**. Les légendes, l'UX/UI et le design sont jugés insuffisants ; ne pas confondre réussite technique et validation visuelle. Suspendre toute consolidation/extension du rendu de la PR #48 avant revue artistique comparative. La PR #46 n'était pas davantage validée artistiquement ; ne pas fusionner #46/#48 sur ce seul motif. Les deux PR restent des références techniques et historiques à examiner, sans devenir automatiquement la base artistique.

**RÉALISÉ techniquement, NON VALIDÉ artistiquement :** la PR #48 ajoute un générateur distinct de paquet de revue privée hors ligne (HTML/CSS/JS). Son rapport indique que l'inspection navigateur du paquet était bloquée : responsive, interactions et qualité visuelle ne sont donc pas VÉRIFIÉS par les tests annoncés. L'existence du paquet et la bonne sélection des médias ne prouvent pas l'UX/UI attendue.

**VALIDÉ pour le processus de reprise :** audit/confrontation au site de référence retenu **IGNANT** (direction éditoriale et pages photographiques) et à **The Spaces** (identification et découverte des lieux), en comparant les pages réelles et leur comportement, avant toute nouvelle consolidation. Travailler sur un **prototype visuel privé borné**, non sur quatre nouveaux articles industrialisés, une refonte en production ou une nouvelle A/B test. Préparer une page d'article étalon avec corpus réel, une entrée d'accueil correspondante, le traitement des légendes et un parcours image → article → suite ; tester desktop/mobile dans un vrai navigateur, livrer les écrans et une prévisualisation réellement consultable par Théodore. Le choix précis de la direction artistique et des composants réutilisables reste **PROPOSÉ / À VALIDER sur prototype visible**, et non une approbation de design.

**Périmètre documentaire conservé pour les essais et la future consolidation :** Marconi n° 32, Maison Piot, Palais Chinois et Maison Coilliot (article existant + six photos privées + illustration séparée). Les autres sujets C1 sont hors de ce groupe ; il n'y a aucune nouvelle extraction ou réécriture d'article à demander. Aucune photographie, texte inédit, donnée de droits ou lien Drive privé dans GitHub, les PR, la CI, le build ou les previews publics. Aucune publication, dépense, fusion ou changement de statut `draft` autorisés. La branche de la PR documentaire #47 contient ce checkpoint ; `main` reste inchangé jusqu'à fusion humaine explicite.

## 0D. RECTIFICATIF VALIDÉ — quatre lots de la prochaine prévisualisation privée des pages article (23-09-2026)

**Périmètre VALIDÉ par Théodore pour ce lot de prévisualisation seulement** : (1) Habitations Marconi, immeuble n° 32, Forest ; (2) Maison Piot, Liège ; (3) Palais Chinois / Palazzina Cinese, Palerme ; (4) **Maison Coilliot, Lille**. **Ne pas remplacer Coilliot par la maison de la rue Warocqué ou Villino Florio.** Ces deux derniers restent des sujets/ressources C1 hors de ce lot ; ce rectificatif n'efface pas les quatre pilotes historiques des PR D1 précédentes. Le groupe de revue comprend trois dossiers éditoriaux nouveaux et l'article Coilliot existant enrichissable en privé, pas quatre articles neufs.

**RÉALISÉ en préproduction privée** : dossier photo/article EN/FR/NL de Marconi (4 JPEG du seul n° 32), Piot (6 JPEG), Palais Chinois (8 JPEG documentaires + 3 planches illustrées dérivées conservées séparément). **Coilliot** : article déjà présent sur `main` dans `src/data/articles.json`, identifiant `maison-coilliot-lille-hector-guimard`, statut `draft`, HERO de façade et deux détails d'enseigne. Le complément récent est constitué de **six photographies documentaires distinctes et une illustration dérivée**, classées en Drive privé, avec manifeste et comparaison avec les trois médias du site. Ce complément n'a **pas** été intégré au site, ni autorisé pour diffusion.

**PROPOSÉS pour la revue artistique sur pages privées navigables** : ordre, placement et dimensions des photographies, pertinence des compléments Coilliot par rapport aux trois médias existants, rythmes des textes et galeries, présentation trilingue. Ne pas refaire l'article Coilliot de zéro, le remplacer automatiquement par un brouillon récent, ni remplacer d'office ses trois médias ; toute variation éditoriale doit être réversible et strictement locale à la prévisualisation. Ne pas qualifier l'ajout du complément comme une implémentation accomplie tant que Work ne l'a pas réellement effectué.

**NON VALIDÉS** : crédits et droits publics des nouvelles photos, usages publics des illustrations dérivées, choix artistique final, passage de `draft` à `published`, exposition des médias dans GitHub/CI/Pages, fusion de PR ou publication. La préparation privée ne donne pas ces autorisations. Le pilote de page doit respecter la séparation des médias privés et du build public. La PR #46 est une base technique candidate pour les pages, sans validation artistique de son accueil ni autorisation de le fusionner.

**Checkpoint inter-chantiers** : correction consignée dans la PR documentaire draft #47 en attente de fusion humaine. Le registre actuellement sur `main` demeure à sa dernière consolidation jusqu'à fusion explicite. Le pôle éditorial conserve les pièces et médias dans Drive privé ; aucun lien Drive privé ni photo de ce groupe n'est versé au dépôt public. La prochaine mission Work doit citer explicitement ce périmètre corrigé et livrer quatre pages article visibles en preview locale privée, non quatre nouveaux articles à publier.
