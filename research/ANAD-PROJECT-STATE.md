...
Transmission opérationnelle du 20-09-2026 : `research/ANAD-HANDOFF-2026-09-20.md` (fondements des décisions, essais, calendrier conditionnel, reprise dans un nouveau chat et futur exposé à Christophe).
...
| Reels / audiovisuel | **VALIDÉ — recalage du 20-09-2026** : le Reel est facultatif. Les essais illustration, plaque de détail, Remotion 5 s et Grok basse définition sont des prototypes/retours d'expérience, aucun Reel final publiable. **Pipeline de référence** : photographies originales et montage déterministe dans DaVinci Resolve Free ; exploration photographique narrative, animation photo contrôlée ou micro-lecture architecturale selon le corpus. Illustration → photographie : expérimentation artistique exceptionnelle possible. **Production du Reel Coilliot illustré suspendue** ; Remotion reporté à après 3–5 pilotes satisfaisants, vidéo générative non standard ; aucune dépense vidéo approuvée. | Dépendance : recevoir et approuver les photographies Coilliot puis décider si un Reel apporte une valeur spécifique ; pas de nouveau spike Remotion imposé. |
