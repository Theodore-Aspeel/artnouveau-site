...
const REQUIRED_SOURCE_FILES = [
  ...
  'src/assets/fonts/cormorant-garamond-italic-latin.woff2',
  'src/assets/fonts/eb-garamond-latin.woff2',
  'src/assets/fonts/outfit-latin.woff2',
  'src/assets/fonts/licenses/cormorant-garamond-OFL.txt',
  'src/assets/fonts/licenses/eb-garamond-OFL.txt',
  'src/assets/fonts/licenses/outfit-OFL.txt',
  'src/assets/scripts/article-access.js',
  'src/assets/scripts/i18n.js',
  'src/assets/scripts/public-routes.js',
...
const REQUIRED_DIST_FILES = [
  ...
  'en/about/index.html',
  'nl/about/index.html',
  'fr/mentions/index.html',
  'en/mentions/index.html',
  'nl/mentions/index.html',
  '404.html',
  'article.html',
  ...
  'assets/fonts/licenses/cormorant-garamond-OFL.txt',
  'assets/fonts/licenses/eb-garamond-OFL.txt',
  'assets/fonts/licenses/outfit-OFL.txt',
  'assets/scripts/article-access.js',
  'assets/scripts/i18n.js',
  'assets/scripts/public-routes.js',
