(function attachSiteI18n(global) {
  ...
  const MESSAGES = {
    fr: {
      ...
      'article.author.links.aria': 'Liens vers le portfolio et le contact de l\u2019auteur',
      ...
      'about.hero.title': 'Christophe Aspel, un regard d\u2019auteur sur les villes',
      'about.image.alt': 'Portrait de l\u2019auteur du projet Art Nouveau et Art D\u00e9co',
      'about.image.caption': 'Christophe Aspel, auteur et photographe du projet.',
      'about.identity.role': 'Auteur-photographe',
      'about.identity.intro': 'Christophe Aspel est l\u2019auteur-photographe du projet Art Nouveau et Art D\u00e9co.',
      'about.localNav.aria': 'Sur cette page',
      'about.localNav.portfolio': 'Voir le portfolio',
      'about.localNav.process': 'Comprendre la d\u00e9marche',
      'about.localNav.contact': 'Contacter',
      'about.portfolio.label': 'Portfolio photographique',
      'about.portfolio.title': 'Trois lieux, trois mani\u00e8res d\u2019entrer dans le d\u00e9tail',
      'about.portfolio.intro': 'Cette s\u00e9lection reprend des photographies d\u00e9j\u00e0 pr\u00e9sentes dans le corpus. Chaque image ouvre directement le r\u00e9cit du b\u00e2timent.',
      'about.portfolio.read': 'Voir les photographies et lire l\u2019article',
      'about.portfolio.coilliot.city': 'Lille',
      'about.portfolio.coilliot.title': 'Maison Coilliot',
      'about.portfolio.coilliot.alt': 'Fa\u00e7ade de la Maison Coilliot \u00e0 Lille',
      'about.portfolio.tulips.city': 'Bratislava',
      'about.portfolio.tulips.title': 'Maison aux tulipes',
      'about.portfolio.tulips.alt': 'Maison aux tulipes \u00e0 Bratislava',
      'about.portfolio.milan.city': 'Milan',
      'about.portfolio.milan.title': 'Aquarium de Milan',
      'about.portfolio.milan.alt': 'Aquarium de Milan',
      'about.process.label': 'Du terrain au r\u00e9cit',
      'about.process.title': 'Un parcours qui part toujours du b\u00e2timent',
      'about.process.step1.title': 'Rep\u00e9rer',
      'about.process.step1.body': 'Un b\u00e2timent, une fa\u00e7ade ou un d\u00e9tail retient le regard dans la ville.',
      'about.process.step2.title': 'Photographier',
      'about.process.step2.body': 'Les vues d\u2019ensemble et les d\u00e9tails construisent une lecture du lieu.',
      'about.process.step3.title': 'Documenter',
      'about.process.step3.body': 'Les rep\u00e8res v\u00e9rifiables compl\u00e8tent les observations sans combler les lacunes.',
      'about.process.step4.title': 'Partager',
      'about.process.step4.body': 'L\u2019article relie les photographies, le contexte et les chemins vers d\u2019autres lieux.',
      'about.meta.description': 'Christophe Aspel, auteur-photographe, pr\u00e9sente son portfolio de fa\u00e7ades et de d\u00e9tails d\u2019Art Nouveau et d\u2019Art D\u00e9co en Europe.',
      'about.meta.title': 'Christophe Aspel, auteur-photographe \u00b7 Portfolio',
      ...
      'home.meta.description': 'Une publication d\u2019auteur consacr\u00e9e aux fa\u00e7ades, aux seuils et aux d\u00e9tails o\u00f9 l\u2019Art Nouveau et l\u2019Art D\u00e9co continuent d\u2019agir \u00e0 travers les villes d\u2019Europe.',
      'home.meta.title': 'Art Nouveau et Art D\u00e9co en Europe',
    ...
    en: {
      ...
      'article.author.links.aria': 'Links to the author\u2019s portfolio and contact',
      ...
      'about.hero.title': 'Christophe Aspel, an author\u2019s eye on cities',
      'about.image.alt': 'Portrait of the author of the Art Nouveau and Art Deco project',
      'about.image.caption': 'Christophe Aspel, author and photographer of the project.',
      'about.identity.role': 'Author-photographer',
      'about.identity.intro': 'Christophe Aspel is the author-photographer of the Art Nouveau and Art Deco project.',
      'about.localNav.aria': 'On this page',
      'about.localNav.portfolio': 'View the portfolio',
      'about.localNav.process': 'Explore the approach',
      'about.localNav.contact': 'Contact',
      'about.portfolio.label': 'Photography portfolio',
      'about.portfolio.title': 'Three places, three ways into the detail',
      'about.portfolio.intro': 'This selection uses photographs already present in the collection. Each image opens the story of the building directly.',
      'about.portfolio.read': 'View the photographs and read the article',
      'about.portfolio.coilliot.city': 'Lille',
      'about.portfolio.coilliot.title': 'Maison Coilliot',
      'about.portfolio.coilliot.alt': 'Facade of Maison Coilliot in Lille',
      'about.portfolio.tulips.city': 'Bratislava',
      'about.portfolio.tulips.title': 'House of Tulips',
      'about.portfolio.tulips.alt': 'House of Tulips in Bratislava',
      'about.portfolio.milan.city': 'Milan',
      'about.portfolio.milan.title': 'Milan Aquarium',
      'about.portfolio.milan.alt': 'Milan Aquarium',
      'about.process.label': 'From fieldwork to story',
      'about.process.title': 'A journey that always begins with the building',
      'about.process.step1.title': 'Notice',
      'about.process.step1.body': 'A building, facade, or detail catches the eye in the city.',
      'about.process.step2.title': 'Photograph',
      'about.process.step2.body': 'Wide views and details build a reading of the place.',
      'about.process.step3.title': 'Document',
      'about.process.step3.body': 'Verifiable markers complete the observations without filling the gaps.',
      'about.process.step4.title': 'Share',
      'about.process.step4.body': 'The article connects photographs, context, and paths towards other places.',
      'about.meta.description': 'Christophe Aspel, author-photographer, presents his portfolio of Art Nouveau and Art Deco facades and details across Europe.',
      'about.meta.title': 'Christophe Aspel, author-photographer \u00b7 Portfolio',
      ...
      'home.meta.description': 'An author publication devoted to facades, thresholds, and details where Art Nouveau and Art Deco still act through European cities.',
      'home.meta.title': 'Art Nouveau and Art Deco in Europe',
    ...
    nl: {
      ...
      'article.author': 'Auteur',
      'article.author.links.aria': 'Links naar het portfolio en het contact van de auteur',
      ...
      'about.hero.title': 'Christophe Aspel, een auteursblik op steden',
      'about.image.alt': 'Portret van de auteur van het project Art Nouveau en Art Deco',
      'about.image.caption': 'Christophe Aspel, auteur en fotograaf van het project.',
      'about.identity.role': 'Auteur-fotograaf',
      'about.identity.intro': 'Christophe Aspel is de auteur-fotograaf van het project Art Nouveau en Art Deco.',
      'about.localNav.aria': 'Op deze pagina',
      'about.localNav.portfolio': 'Bekijk het portfolio',
      'about.localNav.process': 'Ontdek de aanpak',
      'about.localNav.contact': 'Contact',
      'about.portfolio.label': 'Fotografieportfolio',
      'about.portfolio.title': 'Drie plaatsen, drie manieren om het detail binnen te gaan',
      'about.portfolio.intro': 'Deze selectie gebruikt foto\u2019s die al in het corpus aanwezig zijn. Elk beeld opent rechtstreeks het verhaal van het gebouw.',
      'about.portfolio.read': 'Bekijk de foto\u2019s en lees het artikel',
      'about.portfolio.coilliot.city': 'Rijsel',
      'about.portfolio.coilliot.title': 'Maison Coilliot',
      'about.portfolio.coilliot.alt': 'Gevel van Maison Coilliot in Rijsel',
      'about.portfolio.tulips.city': 'Bratislava',
      'about.portfolio.tulips.title': 'Huis met de tulpen',
      'about.portfolio.tulips.alt': 'Huis met de tulpen in Bratislava',
      'about.portfolio.milan.city': 'Milaan',
      'about.portfolio.milan.title': 'Aquarium van Milaan',
      'about.portfolio.milan.alt': 'Aquarium van Milaan',
      'about.process.label': 'Van terrein naar verhaal',
      'about.process.title': 'Een parcours dat altijd bij het gebouw begint',
      'about.process.step1.title': 'Opmerken',
      'about.process.step1.body': 'Een gebouw, gevel of detail trekt de aandacht in de stad.',
      'about.process.step2.title': 'Fotograferen',
      'about.process.step2.body': 'Overzichtsbeelden en details bouwen samen een lezing van de plek.',
      'about.process.step3.title': 'Documenteren',
      'about.process.step3.body': 'Controleerbare gegevens vullen de observaties aan zonder leemtes te verbergen.',
      'about.process.step4.title': 'Delen',
      'about.process.step4.body': 'Het artikel verbindt foto\u2019s, context en paden naar andere plaatsen.',
      'about.meta.description': 'Christophe Aspel, auteur-fotograaf, presenteert zijn portfolio met gevels en details van art nouveau en art deco in Europa.',
      'about.meta.title': 'Christophe Aspel, auteur-fotograaf \u00b7 Portfolio',
      ...
      'home.meta.description': 'Een auteurspublicatie over gevels, drempels en details waarin art nouveau en art deco blijven doorwerken in Europese steden.',
      'home.meta.title': 'Art Nouveau en Art Deco in Europa',
      'home.nav.about': 'Over',
