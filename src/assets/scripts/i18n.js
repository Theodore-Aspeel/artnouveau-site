(function attachSiteI18n(global) {
  ...
  const MESSAGES = {
    fr: {
      ...
      'about.hero.title': 'Christophe Aspel, photographier pour relier les lieux',
      ...
      'about.localNav.portfolio': 'Portfolio',
      'about.localNav.process': 'D\u00e9marche',
      'about.localNav.contact': 'Contact',
      'about.portfolio.label': 'Portfolio photographique',
      'about.portfolio.title': 'Une planche de lieux \u00e0 parcourir',
      'about.portfolio.intro': 'Une s\u00e9lection de photographies d\u00e9j\u00e0 pr\u00e9sentes dans le corpus. Chaque vignette m\u00e8ne directement au b\u00e2timent et \u00e0 son article.',
      'about.portfolio.all': 'Parcourir tous les b\u00e2timents',
      'about.portfolio.detail.label': 'D\u00e9tail',
      ...
      'about.portfolio.coilliotDetail.title': 'Enseigne et signature',
      'about.portfolio.coilliotDetail.alt': 'Enseigne et signature d\u2019Hector Guimard sur la Maison Coilliot',
      ...
      'about.process.aria': 'Parcours \u00e9ditorial',
    ...
    en: {
      ...
      'about.hero.title': 'Christophe Aspel, photographing to connect places',
      ...
      'about.localNav.portfolio': 'Portfolio',
      'about.localNav.process': 'Approach',
      'about.localNav.contact': 'Contact',
      'about.portfolio.label': 'Photography portfolio',
      'about.portfolio.title': 'A contact sheet of places to explore',
      'about.portfolio.intro': 'A selection of photographs already present in the collection. Each image leads directly to the building and its article.',
      'about.portfolio.all': 'Explore all buildings',
      'about.portfolio.detail.label': 'Detail',
      'about.portfolio.coilliot.city': 'Lille',
      'about.portfolio.coilliot.title': 'Maison Coilliot',
      'about.portfolio.coilliot.alt': 'Facade of Maison Coilliot in Lille',
      'about.portfolio.coilliotDetail.title': 'Sign and signature',
      'about.portfolio.coilliotDetail.alt': 'Sign and Hector Guimard signature on Maison Coilliot',
      'about.portfolio.tulips.city': 'Bratislava',
      ...
      'about.process.aria': 'Editorial path',
    ...
    nl: {
      ...
      'about.hero.title': 'Christophe Aspel, fotograferen om plaatsen te verbinden',
      ...
      'about.localNav.portfolio': 'Portfolio',
      'about.localNav.process': 'Aanpak',
      'about.localNav.contact': 'Contact',
      'about.portfolio.label': 'Fotografieportfolio',
      'about.portfolio.title': 'Een contactblad met plaatsen om te verkennen',
      'about.portfolio.intro': 'Een selectie van foto\u2019s die al in het corpus aanwezig zijn. Elke foto leidt rechtstreeks naar het gebouw en zijn artikel.',
      'about.portfolio.all': 'Bekijk alle gebouwen',
      'about.portfolio.detail.label': 'Detail',
      'about.portfolio.coilliot.city': 'Rijsel',
      'about.portfolio.coilliot.title': 'Maison Coilliot',
      'about.portfolio.coilliot.alt': 'Gevel van Maison Coilliot in Rijsel',
      'about.portfolio.coilliotDetail.title': 'Uithangbord en handtekening',
      'about.portfolio.coilliotDetail.alt': 'Uithangbord en handtekening van Hector Guimard op Maison Coilliot',
      'about.portfolio.tulips.city': 'Bratislava',
      ...
      'about.process.aria': 'Redactioneel parcours',
