(function attachSiteI18n(global) {
  ...
  const MESSAGES = {
    fr: {
      ...
      'mentions.content.body': 'Les photographies publi\u00e9es sont des \u0153uvres originales d\u2019Antoine Aspeel. Les informations factuelles sont int\u00e9gr\u00e9es avec prudence et signal\u00e9es comme telles lorsqu\u2019elles restent \u00e0 confirmer.',
    ...
    en: {
      ...
      'mentions.content.body': 'The published photographs are original works by Antoine Aspeel. Factual information is added with care and marked as such when it still needs confirmation.',
    ...
    nl: {
      ...
      'mentions.content.body': 'De gepubliceerde foto\u2019s zijn originele werken van Antoine Aspeel. Feitelijke informatie wordt voorzichtig toegevoegd en als zodanig aangeduid wanneer ze nog bevestigd moet worden.',
      ...
      'mentions.publication.body': 'Art Nouveau en Art Deco in Europa is een auteurspublicatie van Antoine Aspeel.',
