...
const EXPECTED_PAGES = [
  ...
  ['fr', 'about', 'dist/fr/about/index.html', 'Christophe Aspel, photographier pour relier les lieux'],
  ['en', 'about', 'dist/en/about/index.html', 'Christophe Aspel, photographing to connect places'],
  ['nl', 'about', 'dist/nl/about/index.html', 'Christophe Aspel, fotograferen om plaatsen te verbinden'],
...
const PORTFOLIO_ITEMS = [
  ...
  { slug: 'maison-coilliot-lille-hector-guimard', image: 'maison-coilliot-enseigne-signature-hector-guimard.jpg' },
